Feature: Create an account
  ...
  Scenario: Successful account creation
    ...
    And I have entered "peterparker@gmail.com" as email address
    And I have entered "peterparker@gmail.com" as confirm email address
  ...
  Scenario Outline: Unsuccessful account creation
    ...
    Examples:
      ...
      | Google Chrome  | 01/04/1990 | Ana       |          | anaasd@gmail.1.com   | anaasd@gmail.1.com   | 123asd   | 123asd        | checked     | Last Name is required                                                     |
      | Microsoft Edge | 01/04/1990 | Maria     | Silva    | mariaasd@gmail.1.com | mariaasd@gmail.1.com | 123asd   | asd123        | checked     | Password did not match                                                    |
      | Google Chrome  | 01/04/1990 | Bruno     | Souza    | brunoasd@gmail.1.com | brunoasd@gmail.1.com | 123asd   | 123asd        | not checked | You must confirm that you have read and accepted our Terms and Conditions |
